...
//         * @param string $context
//         */
//        $theme_template_file_candidates = apply_filters( WP_PLUGIN_SAFETY_VALIDATOR_DOMAIN .'_theme_templates', $theme_template_file_candidates, $template, $context );
//
//        foreach ( $theme_template_file_candidates as $path ) {
//            if ( $path && is_readable( $path ) ) {
//                /** @param string $path */
//                return apply_filters( WP_PLUGIN_SAFETY_VALIDATOR_DOMAIN .'_located_template', $path, $template, $context );
//            }
//        }
//
...
//         * @param string $context
//         */
//        $plugin_template_file_candidates = apply_filters( WP_PLUGIN_SAFETY_VALIDATOR_DOMAIN .'_plugin_templates', $plugin_template_file_candidates, $template, $context );
//
...
//         * @param string $context
//         */
//        $path = apply_filters( WP_PLUGIN_SAFETY_VALIDATOR_DOMAIN .'_before_render_template', $path, $template, $args, $context );
//
//        if ( '' === $path ) {
//            return '';
//        }
...
//         * @param string $context
//         */
//        $html = apply_filters( WP_PLUGIN_SAFETY_VALIDATOR_DOMAIN .'_rendered_template_html', $html, $template, $args, $context );
//
//        if ( $echo ) {
